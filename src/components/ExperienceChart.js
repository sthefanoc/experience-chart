...
class ExperienceChart extends Component {
    ...
    componentDidMount(){
        ...
        setInterval(function(){
            ...
            activeOption.style.color = selectedSchemeColor[1];
        }, 500);
        ...
        let dataBackend = {
            labels: ["Node.Js", "Express", "Django", "Flask", 'Deno'],
            datasets: [{
                backgroundColor: selectedSchemeColor,
                borderColor: '#fff',
                data: [1.5, 1, 0.6, 0.4,0.2],
            }],
            display: false
        };
        ...
        return (
            <div className="skill-chart">
                <div className="skill-filter padd-15">
                    <button onClick={this.changeFilter} className="active" type="button" value="frontend">Frontend</button>
                    <button onClick={this.changeFilter} type="button" value="backend">Backend</button>
                ...
                <div className="chart-container">
                    <canvas id="chartFrontend" title="frontend" className='' width="25w" height="25h"></canvas>
                    <canvas id="chartBackend" title="backend" className='hidden' width="25w" height="25h"></canvas>
                    <canvas id="chartMobile" title="mobile" className='hidden' width="25w" height="25h"></canvas>
                    <canvas id="chartOther" title="other" className='hidden' width="25w" height="25h"></canvas>
                </div>
